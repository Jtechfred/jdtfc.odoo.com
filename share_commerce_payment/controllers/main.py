...
class ShareCommerceController(http.Controller):
    ...
    @http.route('/payment/share_commerce/return', type='http', auth='public', methods=['POST', 'GET'], csrf=False)
    def share_commerce_return(self, **data):
        ...
        request.env['payment.transaction'].sudo()._handle_feedback_data('share_commerce', data)
